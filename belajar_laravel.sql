...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 28, 2021 at 04:21 AM
...
INSERT INTO `buku` (`id_buku`, `judul_buku`, `pengarang`, `deskripsi`) VALUES
(3, 'Awawarna', 'Cammelia', 'Novel tentang kisah nyata'),
(4, 'Ekspektasi', 'Salad.In', 'Cerita tera kehidupan'),
(5, 'Suiretsim', 'Terbalek', 'Open your mind, look in front of u');
...
CREATE TABLE `jurusan` (
  ...
  `nama_jurusan` varchar(13) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(10, 22, '2021-09-24', '2021-09-29'),
(11, 22, '2021-09-24', '2021-09-29'),
(12, 22, '2021-09-28', '2021-10-03');
...
(21, 'Cassanila', '2021-09-23', 'P', 'Sydney', 'vellam', '827ccb0eea8a706c4c34a16891f84e7b', 11),
(22, 'fagarisa', '2000-02-18', 'L', 'NTB', 'aga', '827ccb0eea8a706c4c34a16891f84e7b', 9),
(23, 'Haqqih', '1999-02-10', 'L', 'Brunei', 'haqqi', '827ccb0eea8a706c4c34a16891f84e7b', 11);
...
--
ALTER TABLE `pengembalian_buku`
  MODIFY `id_pengembalian_buku` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
